...
//{@assert
    _if(!Valid.type(radians, "Number"), Matrix2D.toDegrees, "radians");
//}@assert
...
//{@assert
    _if(!Valid.type(degrees, "Number"), Matrix2D.toRadians, "degrees");
//}@assert
...
//{@assert
    _if(!Valid.type(a, "Array"), Matrix2D.multiply, "a");
    _if(!Valid.type(b, "Array"), Matrix2D.multiply, "b");
//}@assert
...
function Matrix2D_scale(m,   // @arg Matrix2DArray:
                        ...
                        y) { // @arg Number: scale y
                             ...
                             // @help: Matrix2D.scale
//{@assert
    _if(!Valid.type(m, "Array"),  Matrix2D.scale, "m");
    _if(!Valid.type(x, "Number"), Matrix2D.scale, "x");
    _if(!Valid.type(y, "Number"), Matrix2D.scale, "y");
//}@assert
...
//{@assert
    _if(!Valid.type(m, "Array"),      Matrix2D.rotate, "m");
    _if(!Valid.type(angle, "Number"), Matrix2D.rotate, "angle");
//}@assert
...
//{@assert
    _if(!Valid.type(m, "Array"),  Matrix2D.translate, "m");
    _if(!Valid.type(x, "Number"), Matrix2D.translate, "x");
    _if(!Valid.type(y, "Number"), Matrix2D.translate, "y");
//}@assert
...
//}@node
if (global["Matrix2D"]) {
    global["Matrix2D_"] = Matrix2D; // secondary
} else {
    global["Matrix2D"]  = Matrix2D; // primary
}
